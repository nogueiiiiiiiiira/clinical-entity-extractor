"""Extrai texto limpo de arquivos XML, removendo todas as tags e normalizando espacos."""
...
def clean_xml_text(xml_path: str) -> str:
    """Extrai o conteudo da tag <text> do XML, remove tags XML/HTML e normaliza espacos."""
    try:
...
def main() -> None:
    ...
    xml_files = [f for f in os.listdir(Config.NARRATIVES_FOLDER) if f.endswith('.xml')]
    ...
    for xml_file in xml_files:
        ...
        out_path = os.path.join(Config.CLEAN_TEXTS_FOLDER, f"{base}.txt")
